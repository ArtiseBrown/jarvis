...
sudo artise -c "mkdir -p /home/artise/tmp/{package-query,yaourt}"
sudo artise -c "cd /home/artise/tmp"
sudo artise -c "git clone https://aur.archlinux.org/package-query.git"
sudo artise -c "cd /home/artise/tmp/package-query"
sudo artise -c "makepkg -si"
sudo artise -c "cd /home/artise/tmp"
sudo artise -c "git clone https://aur.archlinux.org/yaourt.git"
sudo artise -c "cd /home/artise/tmp/yaourt"
sudo artise -c "makepkg -si"
sudo artise -c "yaourt -Syua"
